...
class Students::TextbooksTest < ApplicationSystemTestCase
  setup do
    @students_textbook = students_textbooks(:one)
  end

  test 'visiting the index' do
    visit students_textbooks_url
    assert_selector 'h1', text: 'Students/Textbooks'
  end

  test 'creating a Textbook' do
    visit students_textbooks_url
    click_on 'New Students/Textbook'
